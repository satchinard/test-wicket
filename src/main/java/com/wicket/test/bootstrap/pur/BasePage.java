...
//        add(new HeaderResponseContainer("footer-container", "footer-container"));
    ...
    protected Navbar newNavbar(String markupId) {
        ...
        navbar.addComponents(NavbarComponents.transform(Navbar.ComponentPosition.LEFT,
                ...
                new NavbarButton<Void>(Liens.class, Model.of("Base CSS")),
                new NavbarButton<Void>(Liens.class, Model.of("Components")),
    ...
    private Component newAddonsDropDownButton() {
        return new NavbarDropDownButton(Model.of("Addons")) {
            ...
            protected List<AbstractLink> newSubMenuButtons(String buttonMarkupId) {
                ...
                subMenu.add(new MenuBookmarkablePageLink<Void>(Liens.class, Model.of("Javascript")).setIconType(GlyphIconType.refresh));
                subMenu.add(new MenuBookmarkablePageLink<Void>(Liens.class, Model.of("DatePicker")).setIconType(GlyphIconType.time));
                subMenu.add(new MenuBookmarkablePageLink<Void>(Liens.class, Model.of("Slider")).setIconType(GlyphIconType.screenshot));
                subMenu.add(new MenuBookmarkablePageLink<Void>(Liens.class, Model.of("DateTimePicker")).setIconType(GlyphIconType.time));
                subMenu.add(new MenuBookmarkablePageLink<Void>(Liens.class, Model.of("SelectPicker")).setIconType(GlyphIconType.search));
                subMenu.add(new MenuBookmarkablePageLink<Void>(Liens.class, Model.of("Github Issues")).setIconType(GlyphIconType.book));
                subMenu.add(new MenuBookmarkablePageLink<Void>(Liens.class, Model.of("Extensions")).setIconType(GlyphIconType.alignjustify));
                subMenu.add(new MenuBookmarkablePageLink<Void>(Liens.class, Model.of("Extensions - Bootstrap FileInput")).setIconType(GlyphIconType.alignjustify));
                subMenu.add(new MenuBookmarkablePageLink<Void>(Liens.class, Model.of("Font Awesome")).setIconType(GlyphIconType.font));
                subMenu.add(new MenuBookmarkablePageLink<Void>(Liens.class, Model.of("X-Editable")).setIconType(GlyphIconType.pencil));
                subMenu.add(new MenuBookmarkablePageLink<Void>(Liens.class, Model.of("Validation")).setIconType(GlyphIconType.okcircle));
                subMenu.add(new MenuBookmarkablePageLink<Void>(Liens.class, Model.of("Summernote")).setIconType(GlyphIconType.edit));
                subMenu.add(new MenuBookmarkablePageLink<Void>(Liens.class, Model.of("Markdown")).setIconType(GlyphIconType.edit));
                subMenu.add(new MenuBookmarkablePageLink<Void>(Liens.class, Model.of("Checkboxes and Toggles")).setIconType(GlyphIconType.check));
                return subMenu;
            }
